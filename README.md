...
Public roadmap repository for cyclone separator CFD: swirling turbulent flow,
pressure drop and particle separation efficiency.
...
- Stairmand/Lapple cyclone geometry.
- Air-only RANS baseline.
- Pressure-drop and swirl-field post-processing.
- Particle tracking extension.
